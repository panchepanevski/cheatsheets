...
mv _.png ~/<dir> Move all PNG files from current folder to a different folder
Command History
...
Search
find <dir> -name <"file"> Find all files named <file> inside <dir>. Use wildcards (_) to search for parts of filenames
